...
public class StudentController {
    ...
    @GetMapping(value = {"/elibrary/student/list"})
    ...
    @GetMapping(value = {"/elibrary/student/new"})
    public String displayNewStudentForm(Model model) {
        model.addAttribute("student", new Student());
        return "student/new";
    }

    @PostMapping(value = {"/elibrary/student/new"})
    public String addNewStudent(@Valid @ModelAttribute("student") Student student,
        ...
        return "redirect:/elibrary/student/list";
    }

    @GetMapping(value = {"/elibrary/student/edit/{studentId}"})
    ...
    @PostMapping(value = {"/elibrary/student/edit"})
    ...
    @GetMapping(value = {"/elibrary/student/delete/{studentId}"})
